  ...
  42                     ; 4 void gb_timer_init(void)
  42                     ; 5 {
  44                     	switch	.text
  45  0000               _gb_timer_init:
  49                     ; 10    TIM2->EGR |= 1<<0;
  ...
  76                     ; 25 }
  79  0024 81            	ret
 122                     ; 27 void gb_delay_us(uint16_t gb_us)
 122                     ; 28 {
 123                     	switch	.text
 124  0025               _gb_delay_us:
 126  0025 89            	pushw	x
 127       00000002      OFST:	set	2
 130                     ; 29 	uint16_t gb_i = gb_us;
 ...
 154  003b 85            	popw	x
 155  003c 81            	ret
 208                     ; 38 void gb_delay_ms(uint16_t gb_ms)
 208                     ; 39 { 
 209                     	switch	.text
 210  003d               _gb_delay_ms:
 212  003d 89            	pushw	x
 213  003e 5204          	subw	sp,#4
 214       00000004      OFST:	set	4
 217                     ; 41 	uint16_t gb_milisec = gb_ms;
 219                     ; 43 	for(gb_i=0; gb_i<gb_ms; gb_i++)
 221  0040 5f            	clrw	x
 222  0041 1f03          	ldw	(OFST-1,sp),x
 225  0043 200c          	jra	L301
 226  0045               L77:
 227                     ; 44 	gb_delay_us(1000);
 229  0045 ae03e8        	ldw	x,#1000
 230  0048 addb          	call	_gb_delay_us
 232                     ; 43 	for(gb_i=0; gb_i<gb_ms; gb_i++)
 ...
 248  0059 81            	ret
 301                     ; 46 void gb_delay_sec(uint16_t gb_secs)
 301                     ; 47 { 
 302                     	switch	.text
 303  005a               _gb_delay_sec:
 305  005a 5204          	subw	sp,#4
 306       00000004      OFST:	set	4
 309                     ; 49 	uint16_t gb_sec =gb_secs;
 311  005c 1f01          	ldw	(OFST-3,sp),x
 313                     ; 50 	for(gb_i=0; gb_i<gb_sec; gb_i++)
 315  005e 5f            	clrw	x
 316  005f 1f03          	ldw	(OFST-1,sp),x
 319  0061 200c          	jra	L141
 320  0063               L531:
 321                     ; 51 	gb_delay_ms(1000);
 323  0063 ae03e8        	ldw	x,#1000
 324  0066 add5          	call	_gb_delay_ms
 326                     ; 50 	for(gb_i=0; gb_i<gb_sec; gb_i++)
 ...
 342  0077 81            	ret
 355                     	xdef	_gb_delay_sec
 356                     	xdef	_gb_delay_ms
 357                     	xdef	_gb_delay_us
 358                     	xdef	_gb_timer_init
 377                     	end
